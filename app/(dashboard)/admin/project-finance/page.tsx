...
export default function AdminProjectFinancePage() {
                ...
                {projectRows.map((project) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-right">
                      <Link href={`/admin/project-finance/${project.id}`} onClick={(event) => event.stopPropagation()}>
          ...
          {activeProjectId && (
            <div className="space-y-4">
              ...
              <div className="surface-card flex flex-col gap-3 p-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <Link href={`/admin/project-finance/${activeProjectId}`} className="w-full sm:w-auto">
